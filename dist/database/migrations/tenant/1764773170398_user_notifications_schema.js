...
async function up(db) {
    ...
    await db.schema.createIndex("user_notifications_branch_idx").on("user_notifications").column("branchId").execute();
...
async function down(db) {
    ...
    await db.schema.dropIndex("user_notifications_branch_idx").execute();
...
//# sourceMappingURL=1764773170398_user_notifications_schema.js.map